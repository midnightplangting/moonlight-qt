...
Item {
    ...
    ColumnLayout {
        ...
        Item {
            ...
            anchors.horizontalCenterOffset: -450  // ← 向左移动 100px，可调整
        ...
        RowLayout {
            ...
            Column {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        width: 140; height: parent.height; radius: 8; color: "#3C3C3C"; clip: true
                        ListView {
                    ...
                    Rectangle {
                        Layout.fillWidth: true; height: 260; radius: 8; color: "#555555"
                        Label {
                            anchors.centerIn: parent
                ...
                Rectangle {
                    id: bannerFrame
                    width: parent.width; height: 280; radius: 8; color: "#555555"; clip: true
            ...
            Column {
                ...
                GridLayout {
                    ...
                    Repeater { model: comboModel
                        Rectangle { width: 150; height: 90; radius: 6; color: index === comboGrid.selectedCombo ? "#414141" : "#303030"; border.color: "#aaaaaa"; border.width: 1
                            Column { anchors.centerIn: parent; spacing: 4
                                Rectangle { visible: model.gift>0; width: parent.width*0.6; height:16; radius:8; anchors.horizontalCenter: parent.horizontalCenter; y:-8; color:"#FFD43A"
                                    Label { anchors.centerIn: parent; text: qsTr("赠")+model.gift+qsTr("金币"); font.pixelSize:10; color:"#333333" }
                                }
                                Label { text: model.coins+qsTr("金币"); font.pixelSize:18; color:"white" }
                                Label { text: "¥ "+model.price.toFixed(2); font.pixelSize:14; color:"#cccccc" }
                            }
                            MouseArea { anchors.fill: parent; onClicked: comboGrid.selectedCombo=index }
                        }
                    }
                }
                Label { text: qsTr("注：金币可用于计时/包时/包机"); color:"#aaaaaa"; font.pixelSize:12 }
                // 支付方式 & 按钮
                RowLayout { spacing:20
                        ...
                        Repeater { model:[{icon:"qrc:/res/wx.svg",text:qsTr("微信付款")},{icon:"qrc:/res/zfb.svg",text:qsTr("支付宝付款")}]
                            delegate: Rectangle { width:200;height:48;radius:4;color:"#444444"
                                RowLayout { anchors.fill:parent;anchors.margins:8;spacing:10
                                    ...
                                    Label { text:modelData.text;color:"white";font.pixelSize:14 }
                    ...
                    Rectangle { id:payButton;width:240;height:60;radius:6;color:"#ffaa33";Layout.alignment:Qt.AlignVCenter
                ...
                Label { text:qsTr("购买即同意《用户协议》和《隐私政策》"); color:"#666666";font.pixelSize:10;horizontalAlignment:Text.AlignHCenter;width:parent.width }
            }
        }
    }
}
